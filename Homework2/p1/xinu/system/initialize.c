...
static	void	sysinit()
{
	...
	for (i = 0; i < NPROC; i++) {
		...
		prptr-> prSystemcallCount = 0;
	
		prptr-> prSleepTime = 0;
		prptr-> prCreateTime = 0;
		prptr-> prWaitTime = 0;			
		prptr-> prSuspendTime = 0;
		prptr-> prReschedTime = 0;
		prptr-> prRecvTime = 0;
		prptr-> prReadyTime = 0;
		prptr-> prSleepTime = 0;
		prptr-> prKillTime = 0;
	...
	prptr->prstkptr = 0;
	currpid = NULLPROC;
	prptr->prtimesec = clktime;
	prptr->prtimemillis = ctr1000;	
	
	prptr->prSystemcallArray[prptr->prSystemcallCount] = 10;
